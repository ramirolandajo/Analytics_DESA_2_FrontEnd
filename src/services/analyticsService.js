...
export const getProductViewsTop = (params) => apiClient.get('/product-views/daily/top', { params }).then((res) => res.data);
export const getProductViewsBottom = (params) => apiClient.get('/product-views/daily/bottom', { params }).then((res) => res.data);
